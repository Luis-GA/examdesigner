...
public class ParserTests {
    ...
    private final String examJsonString = "{\n" +
            ...
            "          \"choices\": [\n" +
            "            {\n" +
            "              \"title\": \"La longitud de la clave puede ser 7.\",\n" +
            "              \"bodyObjects\": []\n" +
            "            },\n" +
            "            {\n" +
            "              \"title\": \"La longitud de la clave puede ser 5.\",\n" +
            "              \"bodyObjects\": []\n" +
            "            },\n" +
            "            {\n" +
            "              \"title\": \"La longitud de la clave puede ser 15.\",\n" +
            "              \"bodyObjects\": []\n" +
            "            },\n" +
            "            {\n" +
            "              \"title\": \"La longitud de la clave puede ser 35.\",\n" +
            "              \"bodyObjects\": []\n" +
            "            }\n" +
            "          ],\n" +
            "          \"correctChoice\": \"La longitud de la clave puede ser 5.\",\n" +
    ...
    private void initializeTestExam() {
        testExam = new Exam();
        ...
        ArrayList<Section> choices = new ArrayList<>();
        choices.add(choice1);
        choices.add(choice2);
        choices.add(choice3);
        choices.add(choice4);
        ...
        question1.setCorrectChoice("La longitud de la clave puede ser 5.");

        ArrayList<Question> questions = new ArrayList<>();
        questions.add(question1);
        part.setQuestions(questions);

        ArrayList<ExamPart> parts = new ArrayList<>();
        parts.add(part);
